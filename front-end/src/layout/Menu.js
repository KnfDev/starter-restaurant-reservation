      ...
      <div className="container-fluid d-flex flex-column p-0 my-5">
        ...
        <ul className="nav navbar-nav" id="accordionSidebar">
          <li className="nav-item nav-font">
            <Link className="nav-link link-text" to="/dashboard">
              <span className="oi oi-dashboard" />
              &nbsp;Dashboard
            </Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link link-text" to="/search">
              <span className="oi oi-magnifying-glass" />
              &nbsp;Search
            </Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link link-text" to="/reservations/new">
              <span className="oi oi-plus" />
              &nbsp;New Reservation
            </Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link link-text" to="/tables/new">
